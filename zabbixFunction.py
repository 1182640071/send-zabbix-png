...
class ZabbixFunction:
    ...
    def __init__(self , url='' , header={"Content-Type":"application/json"} , user='' , password='' , urlpng="http://ip:port/zabbix/chart2.php" , urlvalue="http://ip:port/zabbix/index.php" , token='' , size=0):
        '''
